    ...
    <main>
      <div className="w-full h-screen bg-myimage1 bg-fixed bg-cover ">
        <div className="w-full h-full">
          <h2 className="text-center pt-32 text-7xl font-bold tracking-wider">
            Skills speak louder <br /> than words
          </h2>
          <p className="text-center text-lg font-light pt-6 text-gray-800">
            We help companies develop the strongest tech teams around. We help{" "}
            <br /> candidates sharpen their tech skills and pursue job
            opportunities.
          </p>
          <div className="flex justify-center items-center gap-6 mt-10">
            <button className="px-14 py-2 rounded-sm text-white bg-green-700">
              Sign Up
            </button>
            <button className="px-10 py-2 border rounded-sm border-black">
              Request demo
            </button>
          </div>
        </div>
      ...
      <div className="w-full h-1 flex justify-center items-center bg-black"></div>
